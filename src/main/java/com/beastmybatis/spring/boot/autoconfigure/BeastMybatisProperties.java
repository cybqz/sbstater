 ...
 * @author Chenyingbo
 */
@ConfigurationProperties(prefix = BeastMybatisProperties.MYBATIS_PREFIX)
public class BeastMybatisProperties {

	private static final String COMMON_SQL_CLASSPATH = "beastmybatis/commonSql.xml";
